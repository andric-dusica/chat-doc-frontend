...
const DiscardPromptModal = ({ onDiscard, onCancel }) => {
    return (
        <div className="discard-modal-background">
            <div className="discard-modal-content">
                ...
                <div className='discard-modal-h'>
                    ...
                    <p>You will lose all changes you made to this prompt.</p>
                </div>
                <div className='discard-btns'>
                    <button className='discard-user-btn' onClick={onDiscard}>Discard Changes</button>
...
export default DiscardPromptModal;
